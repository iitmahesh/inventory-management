...
export class GeneralService {
  ...
  submitPurchaseData(purchaseData): Promise<DocumentReference>{
    let invData = {};
    this.checkInventoryForProduct(purchaseData.productDesc, purchaseData.productCode)
    .then(
      value => {
        console.log(value);
        if (value.empty) {
          invData['productCode'] = purchaseData.productCode;
          invData['productDesc'] = purchaseData.productDesc;
          invData['purchaseQty'] = purchaseData.quantity;
          invData['salesQty'] = 0;
        ...
        value.forEach(
          val => {
            ...
            if (!!invData) {
              ...
              invData['purchaseQty'] = purchaseData.quantity + purchaseQty;
        ...
        if (value.empty) {
          ...
          val => {
            ...
            if (!!suppliersData) {
              ...
              suppliersData['openingBalance'] = suppliersData['closingBalance'] ;
              suppliersData['purchaseAmount'] = purchaseData.amount + purchaseAmt;
